...
var app = {
    ...
    startup:function(){
       ...
       //ini fulltext
        ...
        showAlert('startup finished: isToNotify=' + isToNotify + ' isToShortNotify=' + isToShortNotify + ' isToTipsNotify=' + isToTipsNotify + ' iscloth=' + iscloth + ' isfulltext=' + isfulltext + ' issound=' + issound + ' isdailyforecast=' + ' isadfree=' + isadfree, '');
   ...
   renderHomeView: function() {
    ...
    updateUserParams:function(){
        ...
        showAlert('updateUserParams:' + ' isToNotify:' + isToNotify+' isToShortNotify:' + isToShortNotify+ ' isToTipsNotify:' + isToTipsNotify +  ' isdailyforecast:' + isdailyforecast+ ' dailyforecasthour:' + dailyforecasthour, '');
